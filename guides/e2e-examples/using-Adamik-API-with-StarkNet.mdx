...
```bash
npm install starknet @starknet/core get-starknet node-fetch
```
...
```javascript
import { ec } from "@starknet-react/core";
...
- **Network Issues**: Verify you're using the correct network endpoints (mainnet/testnet).
