---
icon: arrow-progress
title: Write API Interaction Flow
---
...
For full implementation details, refer to [`/api/transaction/encode`](../api-reference/current/transaction/encode-a-transaction).
