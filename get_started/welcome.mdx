...
- Check out our [Adamik application](https://app.adamik.io/). See Adamik API in action and understand its potential for your projects.
- Take a look at [Adamik's API overview ](./overview) to get familiar with the main modules the API offers.
- Get your [free API key](https://dashboard.adamik.io)🔑 and make your first request.
