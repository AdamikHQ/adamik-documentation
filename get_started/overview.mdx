...
Beyond the core APIs, Adamik extends its functionality through the **Utility API**: The **Utility API** provides tools for various operational needs, such as address format validation, transaction fee estimation, and network congestion assessment.